...
There is a bug in R-3.4.0 that prevents installation of this package. You will need to install
the current patched version (R-3.4.1) or higher. Download at: 
